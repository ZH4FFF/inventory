...
{
	$queryView="select* from info WHERE Name='".$_SESSION["UID"]."'";
                                                    ...
                                                    <div class="row m-l-0 m-r-0">
                                                        <div class="col-sm-4 bg-c-lite-green user-profile">
                                                            <div class="card-block text-center text-white">
                                                                ...
                                                                <h1 class="f-w-600" ><?php echo $_SESSION["UID"];?>
                                                            ...
                                                            <div class="card-block">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-sm-6">
                                                                        ...
                                                                        <h6 class="text-muted f-w-400"><?php echo $row["Website"];?></h6>
                                                                    </div>
                                                                    <div class="col-sm-6">
                                                                        <p class="m-b-10 f-w-600">Comment</p>
                                                                        <h6 class="text-muted f-w-400"><?php echo $row["Comment"];?></h6>
                                                                    </div>
                                                                    <div class="col-sm-6">
